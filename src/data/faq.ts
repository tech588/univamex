export const faqItems = [
  {
    question: "¿Están incorporados a la SEP?",
    answer:
      "Sí. Los programas se muestran con RVOE o clave correspondiente en cada ficha académica. Si un dato aparece como pendiente de confirmar, el asesor debe validarlo antes de iniciar el proceso.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Depende del nivel académico. En admisiones puedes revisar documentos por bachillerato, licenciatura, maestría y doctorado antes de hablar con un asesor.",
  },
  {
