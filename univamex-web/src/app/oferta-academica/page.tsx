    ...
    <main>
      <section className="bg-[#F8FAFC] px-5 py-12 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            title="Oferta académica"
            description="Encuentra el programa correcto y solicita informes por WhatsApp con contexto de tu carrera de interés."
          />
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              {
                label: "Posgrados",
                href: "/oferta-academica/posgrados",
                text: "Maestrías y doctorado para crecer profesionalmente.",
              },
            ].map((item) => (
              <Link
